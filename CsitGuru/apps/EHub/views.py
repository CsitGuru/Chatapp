import requests
from CsitGuru.apps.MCourse.models import Event
    ...
    def post(self, request):
        ...
        try:
            ...
            if password1 == password2:
                ...
                user_obj.save()
                messages.success(request, "An Account for you was created sucessfully!")
                return redirect("Ehub:sign-in")
            else:
            ...
            print(e)
            messages.error(request, "Sorry Something went wrong in Backend.")
            return redirect("Ehub:sign-up")
import os
...
class SitemapView(View):
    def get(self, request):
        return FileResponse(open('staticfiles/sitemap.xml', 'rb'))
